...
- Hybrid audio playback:
  ...
  - SAMPLE_URLS map with MP3 assets: gangnam.mp3, ingan.mp3, yeoja.mp3, ssanai.mp3
...
- SOUND_MAP: Maps pad dataset.sound attributes to playback functions
  - gangnam, ingan, yeoja, ssanai: playSample() - sample-based playback
  - fart1, fart2, sanae, oppa, zero, guitar, sigh, love: synthesized sounds
