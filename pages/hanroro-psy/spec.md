...
- **12 Sound Pads** (4x3 grid, bottom): Three rows with distinct visual styles and sound categories
  - Row 1 (Pink/Gangnam): "강남" (sample-based), "인간", "여자", "댐걸"
...
- Hybrid audio playback:
  ...
  - SAMPLE_URLS map with MP3 assets: gangnam.mp3, ingan.mp3, yeoja.mp3
...
- SOUND_MAP: Maps pad dataset.sound attributes to playback functions
  - gangnam, ingan, yeoja: playSample() - sample-based playback
  - damn, fart1, fart2, sanae, oppa, zero, guitar, sigh, love: synthesized sounds
