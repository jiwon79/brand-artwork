...
- **12 Sound Pads** (4x3 grid, bottom): Three rows with distinct visual styles and sound categories
  - Row 1 (Pink/Gangnam): "강남", "인간", "여자", "싸나이" (all sample-based)
  - Row 2 (Cyan/Fart): "옵", "완전", "울퉁불퉁", "오빠" (sample-based and synthesized sounds)
  - Row 3 (Cream/Hanroro): "0+0", "기타", "한숨", "사랑해"
...
- Hybrid audio playback:
  ...
  - SAMPLE_URLS map with MP3 assets: gangnam.mp3, ingan.mp3, yeoja.mp3, ssanai.mp3, op.mp3, wanjeon.mp3, ultungbultung.mp3
...
- SOUND_MAP: Maps pad dataset.sound attributes to playback functions
  - gangnam, ingan, yeoja, ssanai, op, wanjeon, ultungbultung: playSample() - sample-based playback
  - oppa, zero, guitar, sigh, love: synthesized sounds
  - Note: sanae was replaced with ultungbultung (sample-based sound)
