...
- Each LTX source contains 97 native frames. Runtime assets use every second source frame, including both endpoints, without optical-flow interpolation, blending, or synthesized in-between frames.
...
- Extract native frames 1, 3, 5, …, 97 to obtain 49 poses. Do not use FFmpeg interpolation, optical flow, crossfades, or blended frames.
- Encode runtime WebP frames at 405 × 720 and share the exact left/right endpoint assets between the two arcs.
