# Guseul Photo Sources

The WebP files in this directory are resized derivatives used inside the Guseul artwork circles.
...
- `peach-squares.webp`: [Unsplash r0PmZTf-a60](https://unsplash.com/photos/an-orange-and-pink-abstract-background-with-squares-r0PmZTf-a60)
- `orange-petals.webp`: [Pexels 31018072](https://www.pexels.com/photo/close-up-of-abstract-orange-petals-31018072/)
- `green-leaf.webp`: [Pexels 6755474](https://www.pexels.com/photo/close-up-of-a-green-leaf-6755474/)

The Pexels images are used under the Pexels license. The Unsplash image is used under the Unsplash license.
