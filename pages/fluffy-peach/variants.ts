...
export const variants: readonly Variant[] = [
  ...
  {
    id: 'bean', label: '민트 콩', referenceDetail: 0.2, flutter: 1.04, depth: 0.92, eyeShift: [-69, -13],
    colors: {
  ...
  {
    id: 'flower', label: '꿀 꽃', referenceDetail: 0.18, flutter: 1.08, depth: 0.94, eyeShift: [-63, 6],
    colors: {
  ...
  {
    id: 'star', label: '보라 별', referenceDetail: 0.14, flutter: 0.92, depth: 0.82, eyeShift: [-69, -4],
    colors: {
  ...
  {
    id: 'wave', label: '파도', referenceDetail: 0.17, flutter: 1.1, depth: 0.86, eyeShift: [-67, -10],
    colors: {
